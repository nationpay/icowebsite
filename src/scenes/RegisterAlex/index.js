                            ...
                            <div className='col-md-6 col-md-offset-3'>
                                ...
                                <form name="form" className="form" onSubmit={this.handleSubmit}>
                                    ...
                                    <div className="label-text">
                                        <p>
                                        To be able to participate in our ICO, you need to state your nationality and country of residence, as part of our KYC process. Please keep in mind that you’ll be required to make proof of your nationality during the KYC process and you will NOT be able to withdraw your tokens if the KYC isn’t successful. SEE LIST OF ELIGIBLE COUNTRIES
                                        </p>
                                    </div>
                                    <div className={'form-group' + (submitted && ( !user.country || validationError.country ) ? ' has-error' : '')}>
                                        <SelectField
                                        className="inputText"
                                   ...
                                   <div className={'form-group' + (submitted && ( !user.country || validationError.country ) ? ' has-error' : '')}>
                                        <Checkbox
                                             label="I have read and agree with the Whitepaper, the Acceptable Use Policy, the Terms and Conditions for Participants, and the Privacy Policy documents."
                                             className="checkBox"
                                   ...
                                   <div className={'form-group' + (submitted && ( !user.country || validationError.country ) ? ' has-error' : '')}>
                                       ...
                                       <Checkbox
                                         label="I declare that I am not a US citizen"
                                         className="checkBox"
