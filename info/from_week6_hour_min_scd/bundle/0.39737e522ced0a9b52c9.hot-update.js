...
var mapStateToProps = function mapStateToProps(state, ownProps) {
    ...
    return {
        myTotalInvestment: state.dashboard.myTotalInvestment,
        icoTotalInvestors: state.dashboard.icoTotalInvestors,
        icoTotalUSD: state.dashboard.icoTotalUSD,
        icoTotalCoins: state.dashboard.icoTotalCoins,
        icoListOfCoins: state.dashboard.icoListOfCoins
    };
};
