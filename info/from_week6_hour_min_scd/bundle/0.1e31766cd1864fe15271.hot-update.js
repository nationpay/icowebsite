...
var mapStateToProps = function mapStateToProps(state, ownProps) {
    ...
    return {
        myTotalInvestment: state.myTotalInvestment,
        icoTotalInvestors: state.icoTotalInvestors,
        icoTotalUSD: state.icoTotalUSD,
        icoTotalCoins: state.icoTotalCoins,
        icoListOfCoins: state.icoListOfCoins
    };
};

var Dashboard = (_dec = (0, _reactRedux.connect)(null, mapDispatchToProps), (0, _reactRouterDom.withRouter)(_class = _dec(_class = (0, _autobindDecorator2.default)(_class = function (_PureComponent) {
