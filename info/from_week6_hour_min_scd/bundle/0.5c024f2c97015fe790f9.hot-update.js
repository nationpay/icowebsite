...
var PrivateRoute = function PrivateRoute(_ref) {
  ...
  console.log('store in PrivateRoute', _store.store.getState());
  console.log('auth.isLoggedIn', _index.auth.isLoggedIn());

  return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, {
    render: function render(props) {
      return _index.auth.isLoggedIn() ? _react2.default.createElement(Component, props) : _react2.default.createElement(_reactRouterDom.Redirect, { to: { pathname: '/login', state: { from: props.location } } });
    }
  }));
};
