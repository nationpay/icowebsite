        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, {
            ...
            render: function render(props) {
              return _index.auth.isLoggedIn() ? _react2.default.createElement(Redirect, { to: { pathname: '/dashboard', state: { from: props.location } } }) : _react2.default.createElement(Redirect, { to: { pathname: '/login', state: { from: props.location } } });
            }
          }),
