...
var Login = (_dec = (0, _reactRedux.connect)(null, mapDispatchToProps), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _autobindDecorator2.default)(_class = function (_PureComponent) {
...
var Register = (_dec = (0, _reactRedux.connect)(null, mapDispatchToProps), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _autobindDecorator2.default)(_class = function (_PureComponent) {
    ...
    _createClass(Register, [{
        ...
        value: function handleSubmit(event) {
            ...
            _bluebird2.default.resolve(areUserInputValid).then(_rutils2.default.when(_rutils2.default.equals(true), function () {
                ...
                console.log('store at registering ', _store2.default.getState());
