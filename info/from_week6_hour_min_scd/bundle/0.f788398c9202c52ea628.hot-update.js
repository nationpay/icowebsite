...
var Login = (_dec = (0, _reactRedux.connect)(null, mapDispatchToProps), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _autobindDecorator2.default)(_class = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function handleSubmit(e) {
      ...
      var isNotEmpty = _rutils2.default.o(_rutils2.default.compl, _rutils2.default.isEmpty);

      var isValid = function isValid(x) {
        return _rutils2.default.isNotNil(x) && _rutils2.default.compl(_rutils2.default.isEmpty(x));
      };

      console.log('Ru.isNotNil-email', _rutils2.default.isNotNil(email));
      console.log('Ru.empty-email', _rutils2.default.compl(_rutils2.default.isEmpty(email)));
      console.log('Ru.isNotNil-password', _rutils2.default.isNotNil(password));
      console.log('Ru.empty-password', _rutils2.default.isEmpty(password));
